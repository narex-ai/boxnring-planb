...
def create_env_file():
    ...
    env_vars = {
        ...
        "GOOGLE_MODEL": input("Gemini Model (default: gemini-1.5-flash): ").strip() or "gemini-1.5-flash",
        ...
        "GLOVY_RESPONSE_MODEL": input("Glovy Response Model (default: gemini-1.5-flash): ").strip() or "gemini-1.5-flash",
